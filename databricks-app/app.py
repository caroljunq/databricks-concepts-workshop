...
def getData():
    ...
    return sqlQuery("select * from workshop_rails.rails.automl limit 100")
...
# Substitua pelo seu código de embed gerado no Databricks
dashboard_url = "https://dbc-70ec2549-2269.cloud.databricks.com/embed/dashboardsv3/01f104f7e6121b45a4f1a6f864f65c1f?o=7474649028799941"
...
genie_space_id = "01f104eb1bee1d66870947dd1eca34e1"
...
st.markdown("Pergunte o que quiser sobre o dataset de inadimplência e obtenha insights in linguagem natural!")
